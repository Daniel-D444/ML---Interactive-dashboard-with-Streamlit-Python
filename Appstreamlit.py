...
def main():
    ...
    st.markdown("Are you mushroom edible or poisonous?  ")
    st.sidebar.markdown("Are you mushroom edible or poisonous?  ")

    @st.cache_data(persist=True)
    def load_data():
        data = pd.read_csv('C:/Users/gnang/OneDrive/Bureau/coursera/Project/mushrooms.csv')
        label = LabelEncoder()
    ...
    if classifier == 'Random Forest':
        st.sidebar.subheader("Model Hyperparameters")
        n_estimators = st.sidebar.number_input("The number of tres in the forest", 100, 500, step = 10, key = 'n_estimators')
